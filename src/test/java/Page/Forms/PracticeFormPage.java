...
public class PracticeFormPage extends BasePage {
    ...
    protected By Rdo_Gender(Gender gender) { return By.id(String.format("gender-radio-%s", gender.value)); }
    protected By Txt_Mobile = By.id("userNumber");
    protected By Txt_DateOfBirth = By.id("dateOfBirthInput");
    protected By Txt_Subject = By.cssSelector("subjectsInput");
    protected By Chk_Hobby(Hobbies hobby) { return By.id(String.format("hobbies-checkbox-%s", hobby.value)); }
